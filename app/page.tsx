...
<div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
  ...
  {/* Membership CTA removed per request */}
    ...
    <div className="mt-5 max-w-2xl text-center mx-auto">
      <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
        AI
        <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> Scribe</span>
      </h1>
    </div>
  ...
  The AIScribe uses state-of-the-art generative models to help you create articles, social posts, descriptions, and more — fast. Enter a prompt or use one of our templates to produce clear, relevant, and polished content tailored to your needs, saving you time while improving consistency and engagement.
      </p>
    </div>
